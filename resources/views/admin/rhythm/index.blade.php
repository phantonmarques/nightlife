        ...
        <div class="col-md-12">
            <div class="box box-warning">
                <div class="box-header with-border">
                    ...
                    <div class="col-xs-3 col-sm-2 no-padding separate pull-left" id="displayDelete" style="display: none;">
                        <a class="btn btn-warning btn-flat" href="{{ route('rhythm.massDestroy') }}" id="deleteSelected"
                           title="Exclusão de ritmos musical selecionado">
