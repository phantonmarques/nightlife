        ...
        <div class="col-md-12">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    {{--                        <div class="col-lg-3">--}}
                    {{--                            <br>--}}
                    {{--                            <button type="button" class="btn btn-success" onclick="searchInformationCompany()">--}}
                    {{--                                Verificar--}}
                    {{--                            </button>--}}
                    {{--                        </div>--}}
                    {{--                        <div class="col-lg-2" id="infReceita">--}}
                    {{--                            {{ Form::label('', false,['id' => 'situationEstablishment']) }} <br>--}}
                    {{--                            {{ Form::label('', false,['id' => 'statusEstablishment']) }} <br>--}}
                    {{--                            {{ Form::label('', false,['id' => 'openedEstablishment']) }} <br>--}}
                    {{--                        </div>--}}
                    {{--                    </div>--}}
                </div>
