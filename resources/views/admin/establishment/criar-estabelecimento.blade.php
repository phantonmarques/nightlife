...
@section('content')
    <div class="box">
        <div class="box box-success">
            ...
            <form method="POST" action="{{ Route('inserirEstabelecimento') }}"  id="frm_cadastroEstab" onsubmit="return validarFormulario(this)">
                {!! csrf_field() !!}
                <div class="box-body">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="estadoEstab" name="estadoEstab" onchange="buscarCidade()">
                                    ...
                                    @foreach($estados as $est)
                                        <option value="{{ $est->state_cod }}">{{ $est->name_visible }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-6">
