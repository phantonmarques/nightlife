        ...
        <div class="login-box-body">
            ...
            <div class="auth-links">
                ...
                <?php if(config('adminlte.register_url', 'register')): ?>
                    <a href="<?php echo e(Route('register.page')); ?>"
                       class="text-center"
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projetos Desenvolvimento\ProjetosPhpStorm\ProjetosLaravel\nightlife\resources\views/vendor/adminlte/login.blade.php ENDPATH**/ ?>