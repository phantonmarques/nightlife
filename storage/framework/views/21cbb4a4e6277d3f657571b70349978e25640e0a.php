<?php $__env->startSection('title', 'Página de Login'); ?>
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo e(route('inicio')); ?>"> <img src="<?php echo asset('assets/site/imgs/logo-nightlife.png'); ?>" style="width: 75%;margin-top: -50px;"></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Se logue </p>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Phanton\Documents\Projetos\Php\nightlife\resources\views/site/template/login.blade.php ENDPATH**/ ?>